...
/// <summary>
/// Runs the SMTP relay (and FTP bridge) inside the GUI process using Gmail + Google Drive.
/// </summary>
public sealed class InProcessRelayConnection : IRelayConnection
{
    ...
    public Task StartAsync(CancellationToken ct = default)
    {
        ...
        var mailSender = new GmailMailSender(_config, _logger);
        var fileStorer = new GoogleDriveFileStorer(_config, _logger);
