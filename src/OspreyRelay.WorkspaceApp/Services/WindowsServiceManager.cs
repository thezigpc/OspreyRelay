...
namespace OspreyRelay.WorkspaceApp.Services;

public static class WindowsServiceManager
{
    public const string ServiceName = "OspreyRelayWorkspace";
    private const string ServiceDisplay = "Osprey Relay for Workspace";
    private const string ServiceDescription =
        "Routes SMTP email from local devices through Google Workspace via the Gmail API.";
